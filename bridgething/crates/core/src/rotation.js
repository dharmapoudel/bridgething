...
(function () {
  ...
  var REFLOW_CSS =
    ...
    'div:has(>div[style*="grid-template-columns"]){display:block !important;overflow-y:auto !important;}';
  ...
  function watchReflow() {
    ...
    reflowObserver = new MutationObserver(function () {
      if (isPortrait() && isHubPage() && !document.getElementById(REFLOW_STYLE_ID)) {
        applyReflow();
      }
    });
